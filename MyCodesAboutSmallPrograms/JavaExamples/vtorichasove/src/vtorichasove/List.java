...
public class List<E>
{
   ...
   public <E> E removeFromFront() throws EmptyListException
   {
      if ( isEmpty() ) // throw exception if List is empty
         throw new EmptyListException( name );

     E removedItem = (E) firstNode.data; // retrieve data being removed
   ...
   public E removeFromBack() throws EmptyListException
   {
      ...
      E removedItem = (E) lastNode.data; // retrieve data being removed
   ...
   public E peekFirst()
   { 
      return (E) ((firstNode == null)?null:firstNode.getObject()); // return Object in firstNode
   ...
   public E peekLast()
   { 
      return (E) ((lastNode == null)?null:lastNode .getObject()); // return Object in lastNode
   } // end method peekLast()
